...
do_everything('', 'single', only_test_split, 'verification', 'cybhi_single_verification.json')
# do_everything('multi', 'multi', only_test_split, 'verification', 'multi_multi_verification2.json')
# do_everything('healthy', 'single', classic_split, 'identification', 'healthy_single_identification2.json')
# do_everything('multi', 'single', classic_split, 'identification', 'multi_single_identification2.json')
# do_everything('multi', 'multi', autoencoder_split, 'identification', 'multi_multi_identification2.json')